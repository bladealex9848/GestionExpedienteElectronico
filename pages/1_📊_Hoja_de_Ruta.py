...
fecha_actual = datetime.now(bogota_tz).replace(hour=0, minute=0, second=0, microsecond=0) # (No visualiza las actividades completadas ni en proceso)
...
def cargar_datos():
    data = {
        ...
        'Formación del equipo de revisión interdisciplinaria': {'Start': '2024-08-16', 'Finish': '2024-08-16'},
        'Distribución de materiales': {'Start': '2024-08-17', 'Finish': '2024-08-17'},
        'Proceso de revisión': {'Start': '2024-08-18', 'Finish': '2024-08-29'},
        'Recopilación y análisis del informe ejecutivo': {'Start': '2024-08-30', 'Finish': '2024-09-01'},
        'Ajustes y mejoras': {'Start': '2024-09-02', 'Finish': '2024-09-08'},
        'Validación de ajustes': {'Start': '2024-09-09', 'Finish': '2024-09-10'},
        'Planificación de la implementación piloto': {'Start': '2024-09-11', 'Finish': '2024-09-15'},
        'Preparación de materiales de capacitación': {'Start': '2024-09-16', 'Finish': '2024-09-22'},
        'Lanzamiento del proyecto piloto': {'Start': '2024-09-23', 'Finish': '2024-10-06'},
        'Monitoreo y evaluación del piloto': {'Start': '2024-10-07', 'Finish': '2024-10-20'},
        'Ajustes finales': {'Start': '2024-10-21', 'Finish': '2024-10-27'},
        'Planificación del despliegue general': {'Start': '2024-10-28', 'Finish': '2024-11-03'},
        'Inicio del despliegue general': {'Start': '2024-11-04', 'Finish': '2024-11-17'},
        'Seguimiento y soporte continuo': {'Start': '2024-11-18', 'Finish': '2024-12-01'},
        'Preparación para la integración con Alfresco': {'Start': '2024-12-02', 'Finish': '2024-12-15'}
    }
...
def crear_gantt(df):
    fig = ff.create_gantt(df, colors={
        ...
        'En proceso': '#2196F3',
        'Pendiente': '#9E9E9E'
    }, index_col='Estado', show_colorbar=True, group_tasks=True)
...
def main():
    ...
    st.sidebar.write("<div style='text-align: center;'>v.1.3.4 Lite | v.1.4.2 Ultimate</div>", unsafe_allow_html=True)
    ...
    st.markdown(f'<p class="small-font" style="text-align:right;">📅 Fecha actual: {fecha_actual.strftime("%Y-%m-%d")}</p>', unsafe_allow_html=True)
